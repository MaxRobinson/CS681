          ...
          <div class="col-md">
            <form action="BhcController" method=GET>
              ...
              <div class="form-group">
                ...
                <select name="Hike" id="Hike" class="form-control" onclick="changeDuration()">
                  <option>Gardiner Lake</option>
                  <option>Hellroaring Plateau</option>
                  <option>The Beaten Path</option>
                </select>
              </div>
              ...
              <jsp:setProperty name="hikesubmit" property="*" />
