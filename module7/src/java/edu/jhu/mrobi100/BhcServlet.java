...
public class BhcServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String responseMessage = query(month, day, year, hike, duration);
    ...
    private String query(String sMonth, String sDay, String sYear, String hike, String sDuration) {
        int month;
        int day;
        int year;
        int duration; 
