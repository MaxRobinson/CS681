    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <div class="col-md">
            <% 
              if(hikeSubmit.isError()){
            %>
            <h4><%=hikeSubmit.getErrorMessage()%></h4>
            <%
            } else {
            %>
            <h4>Total Cost: ${hikeSubmit.cost}</h4>
            <%
                }
            %>
            <br>
            ...
            <div>
                <table class="table">
                    <tbody>
                      <tr>
                        <td> Hike </td>
                        <td> ${hikeSubmit.hikeName}</td>
                      </tr>
                      <tr>
                        <td> Start Date </td>
                        <td> ${hikeSubmit.date} </td>
                      </tr>
                      <tr>
                        <td> Duration </td>
                        <td> ${hikeSubmit.duration} </td>
                      </tr>
                      <tr>
                        <td> No. People </td>
                        <td> ${hikeSubmit.numberOfPeople} </td>
                      </tr>
                    </tbody>
                  </table>
            </div>
