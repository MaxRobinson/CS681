...
public class TestClass {
  ...
  @Test
  public void main() {
    Destroyer d1 = new Destroyer(1,1, "d1","who", -1);
    Destroyer d2 = new Destroyer(1,1, "d2","who", -1);

    Submarine s1 = new Submarine(1,1, "s1", "hello", 5);
    Submarine s2 = new Submarine(1, 1, "s2", "hello", 41);
